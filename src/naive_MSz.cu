...
int main(int argc, char** argv) {
    ...
    std::ofstream outFilep("../gannt_results/naive_MSz/"+filename+"_"+compressor_id+"_rank_"+std::to_string(rank)+".txt", std::ios::app);
    ...
    if(rank == 0){
        ...
        std::ofstream outFile3("../stat_result/"+result_dir+"/naive_MSz/"+filename+"_"+compressor_id+"_"+std::to_string(size)+".txt", std::ios::app);
